...
{
    public class ChatAppRepon : Repository<ChatApp>, IChatApp
    {
        private DbcontextBanDo _dbcon;

        public ChatAppRepon(DbcontextBanDo dbcontext):base(dbcontext)
        {
            _dbcon = dbcontext;

        }

        public void UpdateChatApp(ChatApp chatApp)
        {
            _dbcon.Update(chatApp);
        }
